  ...
  return (
    <div>
      <SettingWrapper
        ...
        sub="Chat, alerting, ticketing, dashboards, and webhooks."
      >
        <div className="grid grid-cols-1 2xl:grid-cols-2 gap-8 items-start pt-5">
          {/* MESSAGING & PAGING */}
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 border border-neutral-500 rounded-2xl space-y-3">
                ...
                <p className="text-[#64748B] text-xs">
                  Notifications + approvals + Ezra summaries.
                </p>
              </div>
              ...
              <div className="p-5 border border-neutral-500 rounded-2xl space-y-3">
                ...
                <p className="text-[#64748B] text-xs">
                  Escalations and on-call mapping.
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="pt-6 flex justify-end">
          <CButton className="w-fit px-10">Save</CButton>
        </div>
      </SettingWrapper>
    </div>
  );
...
const StatusBadge = ({ type, label, icon }: any) => (
  <div
    className={`flex items-center gap-1.5 px-3 py-1 border rounded-full bg-[#0B1224] ${
      type === "success" ? "border-[#00CAD8]/50" : "border-[#64748B]/40"
    }`}
  >
    <span className={type === "success" ? "text-[#00CAD8]" : "text-[#64748B]"}>
      {icon}
    </span>
...
const SimpleIntegrationCard = ({ title, desc, btnLabel }: any) => (
  <div className="p-5 border border-neutral-500 rounded-2xl space-y-3 group hover:border-[#00CAD8]/30 transition-colors">
    ...
    <p className="text-[#64748B] text-xs leading-normal max-w-[200px]">
      {desc}
    </p>
  </div>
);
