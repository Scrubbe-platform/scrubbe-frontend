...
const Pages = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: [querykeys.POSTMORTEM_TICKET, statusFilter],
    queryFn: async () => {
      try {
        const res = await get(
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (info: CellContext<Ticket, unknown>) =>
        moment(info.getValue() as string).format("DD-MM-YYYY HH:mm a"),
    },

    {
      ...
      cell: (info: CellContext<Ticket, unknown>) => {
        ...
        const handleViewDetails = () => {
          ...
          router.push("/incident/timeline/" + id);
        };
        return (
  ...
  if (isLoading) {
    ...
    content = <Table data={incidentTickets} columns={columns} />;
  }
    ...
    <div className="p-4">
      ...
      <div className="flex justify-between items-start my-5">
        <div className="relative w-1/2">
          ...
          <div className="absolute right-2 top-1/4 pb-2">
