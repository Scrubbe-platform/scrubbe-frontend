...
const IPAddressMultipleAccountChart = () => {
  ...
  const getChartOptions = (darkTheme: boolean) => {
    ...
    const barBackgroundColor = darkTheme ? "#60a5fa" : "#93c5fd"; // blue-400 for dark vs blue-300 for light
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: "IP addresses vs number of accounts",
        data: dataValues,
        backgroundColor: isDarkTheme ? "#60a5fa" : "#93c5fd", // blue-400 for dark, blue-300 for light
...
export default IPAddressMultipleAccountChart;
