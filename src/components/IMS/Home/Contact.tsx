...
const Contact = () => {
  ...
  return (
    <div className=" overflow-hidden relative">
      <div className="absolute left-1/3 translate-x-[-15%] bg-gradient-to-r from-cyan-500 to-green-200 blur-3xl opacity-20 w-[50%] h-full rounded-full" />
      ...
      >
        ...
        >
          <span className="text-cyan-500">The Incident Platform</span> That
          Actually Learns
        </motion.p>
        <motion.p
        ...
        >
          <CButton
            ...
            className="  w-full px-5 h-[45px] bg-cyan-500 hover:bg-cyan-500 shadow-none text-base"
          >
            Start for Free
          </CButton>
          <CButton
        ...
        >
          ...
          />
          <div className="h-[42px] max-sm:rounded-lg sm:rounded-r-lg bg-cyan-500 text-white flex items-center px-6 font-semibold cursor-pointer">
            Schedule a Demo
          </div>
        </motion.div> */}
      </motion.div>
