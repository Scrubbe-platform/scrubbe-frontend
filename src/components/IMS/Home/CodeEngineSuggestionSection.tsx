    ...
    <div ref={ref} className="w-full bg-white">
      <div className="max-w-[1100px] mx-auto px-6 py-10">
        <div className="border border-gray-200 rounded-2xl overflow-hidden">
          {/* ── TOP INFO ROW ── */}
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 p-8 pb-0">
            ...
            <div className="flex flex-row items-center divide-x divide-gray-200">
              {[
                ...
                {
                  value: "<40s",
                  label: "Suggestion to PR open",
                  color: "#22c55e",
                },
                {
                  value: "100%",
                  label: "Auditable — every suggestion logged",
                  color: "#f59e0b",
                },
              ].map((stat) => (
                <div key={stat.label} className="px-8 py-4">
                  <p
                    className="font-black text-[28px] leading-none mb-1"
                    style={{ color: stat.color }}
                  >
                    {stat.value}
                  </p>
                  <p className="text-[11px] text-gray-400 max-w-[120px] leading-snug">
                    {stat.label}
                  </p>
                </div>
              ))}
          ...
          <div className="mt-6" style={{ background: "#0d1117" }}>
            ...
            >
              ...
              <div className="ml-auto pr-4 text-[10px] text-gray-600 flex items-center gap-2">
                <span>src/middleware/auth.ts</span>
                <span>·</span>
                <span className="text-emerald-500">conf: 0.91</span>
              </div>
            </div>
          ...
          {/* White background, 4 columns, icon-left layout matching image exactly */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-x divide-y lg:divide-y-0 divide-gray-100">
            {FEATURES.map((f, i) => (
              <div key={f.title} className="flex items-start gap-4 p-6">
                {/* Small dark square icon box */}
                <div
