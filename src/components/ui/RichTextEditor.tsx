...
export default function RichTextEditor({
  ...
  return (
    <div className="rounded-md border border-[#DDDDDD] dark:border-zinc-800 overflow-hidden shadow-2xs mt-1.5 focus-within:border-zinc-400 dark:focus-within:border-zinc-600 transition-all bg-white dark:bg-zinc-950">
