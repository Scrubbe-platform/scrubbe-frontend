  ...
  return (
    <>
      ...
      <section className="w-full h-auto  sticky top-0 z-50">
        <nav className=" flex items-center text-black h-16 w-full  mx-auto sticky top-0 z-50 dark:bg-dark bg-white shadow-sm dark:border-gray-500 border-b border-gray-200">
          ...
          <div className=" w-full flex justify-between items-center px-8 ml-10">
            ...
            <div className="flex items-center justify-center flex-1 max-w-md">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-2 dark:bg-transparent dark:border-gray-500 border-gray-200 border  bg-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black placeholder-gray-400"
                />
            ...
            <aside className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <span className="text-black font-medium whitespace-nowrap dark:text-white">
                  Alex Martins
                </span>
