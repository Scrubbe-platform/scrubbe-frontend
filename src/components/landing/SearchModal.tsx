        ...
        <form onSubmit={handleSubmit} className="relative">
          <div className="flex items-center border-b border-gray-200">
            ...
            <input
              ...
              className="w-full p-3 sm:p-4 pl-2 text-base sm:text-lg text-black bg-transparent outline-none"
            />
            <button
              type="button"
              onClick={onClose}
              className="p-2 mr-2 text-gray-500 hover:text-black hover:bg-gray-100 rounded-full transition-colors cursor-pointer"
            >
              <IoMdClose size={18} />
            </button>
          </div>
